...
.setColor('#0b74de') 
.setAuthor(`Nortox Genel Komutlar`, client.user.avatarURL())
.setDescription(`<a:hypesquad1:756152750282375234> Pirate botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
.addField(`__Komut Sayısı__`,`<a:hypesquad1:756152750282375234> \`${prefix}komutlar\` Botun Komut Sayısını Gösterir`,true)
.addField(`__Davet Et__`,`<a:hypesquad1:756152750282375234> \`${prefix}davet\` Botumuzu Davet Edersiniz`,true)
