...
.setColor('#0b74de') 
.setAuthor(`Nortox Davet Sistemi`, client.user.avatarURL())
.setDescription(`<a:hypesquad1:750076071721828452> Nortox botumuzu eklemek için \`${prefix}davet\` yazabilirsiniz.`)
