...
{
              var embed = new Discord.MessageEmbed()
                .setDescription(`<:aktif:755838164626833459> Modlog Kanalı Başarıyla ${logk} olarak ayarlandı.\n Kapatmak için **__Örnek Kullanım__** : \`${prefix}modlog kapat\``)
                .setColor("BLACK")
            message.channel.send({embed})
            return
          }
...
exports.config = {
    name: "mod-log",
    aliases: ['mod-log','modlog-ayarla','log-ayarlama','modlog','log','vkanal','kayıtkanalı','d']
}